import { FiscalEmitterValidatorFactory } from '../../fiscal-emitter.validator';
import { FiscalEmitterRules } from '../../fiscal-emitter.validator';

describe('FiscalEmitterValidator End-to-End Tests', () => {
  ...
  it('should fail validation for missing required fields', () => {
    const invalidData: Partial<FiscalEmitterRules> = {
      document: '123456789',
      cnaeCode: '6201-5/00',
      activityCode: '12345',
      aliquot: 5.5,
    ...
    const validator = FiscalEmitterValidatorFactory.create();
    const isValid = validator.validate(invalidData as FiscalEmitterRules);
  ...
  it('should fail validation for invalid dates', () => {
    const invalidData: FiscalEmitterRules = {
      name: 'Valid Company',
      document: '123456789',
      email: 'test@valid.com',
